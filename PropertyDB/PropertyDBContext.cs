...
namespace PropertyDB
{
    public class PropertyDBContext : DbContext
    {
        ...
        //Invoice
        public DbSet<CssCustomer> Customer { get; set; }
        public DbSet<CssInvoice> Invoice{ get; set; }
        public DbSet<CssInvoiceDetail> InvoiceDetail { get; set; }
